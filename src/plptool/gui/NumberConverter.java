...
public class NumberConverter extends javax.swing.JFrame
{
	...
	private void convert()
	{
		...
		try
		{
			...
			if (valid)
			{
				...
				Msg.E("Can not convert the number '" + txtInput.getText() + "'",
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(NumberConverter.class);
		...
		cmbBase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1",

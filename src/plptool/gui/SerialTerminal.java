...
public class SerialTerminal extends javax.swing.JFrame
{
	...
	public SerialTerminal(boolean standalone)
	{
		...
		if (serialSupport && Config.serialTerminalAutoDetectPorts)
		{
			...
			while (portList.hasMoreElements())
			{
				...
				Msg.D("rxtx portId name: " + portId.getName() + " type: "
						+ portId.getPortType(), 2, null);
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(SerialTerminal.class);
		...
		cmbPort.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1",
		...
		cmbBaud.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1",
				"Item 2", "Item 3", "Item 4" }));
		...
		cmbOpts.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1",
				"Item 2", "Item 3", "Item 4" }));
		...
		cmbFormat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1",
				"Item 2", "Item 3", "Item 4" }));
		...
		cmbEnter.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1",
				"Item 2", "Item 3", "Item 4" }));
		...
		cmbFontSize.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(
										...
										.addComponent(cmbPort,
												...
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(lblBaud)
										.addComponent(cmbBaud,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(lblOpts)
										.addComponent(cmbOpts,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(
						...
						.addGroup(
								layout.createParallelGroup(
										...
										.addComponent(chkEnter)
										.addComponent(cmbEnter,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(btnSave).addComponent(btnSendFile))
						.addPreferredGap(
								javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(
								layout.createParallelGroup(
		...
		try
		{
			...
			switch (cmbFormat.getSelectedIndex())
			{
				...
				case 1:
					...
					out.write(dataout);
					if (chkEcho.isSelected())
						appendByte((char) dataout, (chkHEX.isSelected() ? Color.MAGENTA
								: Color.BLUE));
					break;
	...
	private void consoleKeyTyped(java.awt.event.KeyEvent evt)
	{// GEN-FIRST:event_consoleKeyTyped
	...
	{// GEN-FIRST:event_btnCopySelectionActionPerformed
	...
	{// GEN-FIRST:event_consoleKeyPressed
		...
		try
		{
			...
			else
			{
				...
				if (chkEcho.isSelected())
					appendByte((char) data, (chkHEX.isSelected() ? Color.MAGENTA
							: Color.BLUE));
			}
	...
	private void consoleFocusGained(java.awt.event.FocusEvent evt)
	{// GEN-FIRST:event_consoleFocusGained
		lblClickNotice.setVisible(false);
	}// GEN-LAST:event_consoleFocusGained
	
	private void consoleFocusLost(java.awt.event.FocusEvent evt)
	{// GEN-FIRST:event_consoleFocusLost
	...
	{// GEN-FIRST:event_btnSendFileActionPerformed
				...
				while (!stop)
				{
					...
					if (bytes > 0)
						try
						{
							...
							appendStringFormatted(
									new String(buffer, 0, bytes, "US-ASCII"), Color.GREEN);
						}
						catch (Exception e)
						{

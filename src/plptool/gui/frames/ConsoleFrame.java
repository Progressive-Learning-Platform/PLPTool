...
public class ConsoleFrame extends javax.swing.JFrame
{
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(ConsoleFrame.class);
		...
		cmd.setBorder(javax.swing.BorderFactory.createLineBorder(resourceMap
				.getColor("cmd.border.lineColor"))); // NOI18N
		...
		layout.setHorizontalGroup(layout
				...
				.addComponent(cmd, javax.swing.GroupLayout.DEFAULT_SIZE, 389,
						Short.MAX_VALUE)
				.addComponent(jscroll, javax.swing.GroupLayout.DEFAULT_SIZE, 389,
						Short.MAX_VALUE));
		layout.setVerticalGroup(layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup()
						.addComponent(cmd, javax.swing.GroupLayout.PREFERRED_SIZE, 26,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(
								javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jscroll, javax.swing.GroupLayout.DEFAULT_SIZE, 122,
								Short.MAX_VALUE)));
	...
	private void cmdKeyPressed(java.awt.event.KeyEvent evt)
	{// GEN-FIRST:event_cmdKeyPressed
		try
		{
			if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER)
			{
				...
				{
					java.util.HashMap<String, Object> attributes = plp
							.getProjectAttributeSet();
					Object[] entrySet = attributes.entrySet().toArray();
					Msg.P("Project attributes:");
					for (int i = 0; i < entrySet.length; i++)
					{
						@SuppressWarnings("unchecked")
						java.util.Map.Entry<String, Object> entry = (java.util.Map.Entry<String, Object>) entrySet[i];
				...
				{
					java.util.HashMap<String, String> attributes = plptool.gui.PLPToolApp
							.getAttributes();
					Object[] entrySet = attributes.entrySet().toArray();
					...
					{
						@SuppressWarnings("unchecked")
						java.util.Map.Entry<String, String> entry = (java.util.Map.Entry<String, String>) entrySet[i];
						Msg.p(entry.getKey() + "::" + entry.getValue());
					}
					Msg.P();
				}
				...
				{
					javax.swing.text.html.HTMLDocument hDoc = (javax.swing.text.html.HTMLDocument) plp.g_dev
							.getOutput().getDocument();
					((javax.swing.text.html.HTMLEditorKit) plp.g_dev.getOutput()
							.getEditorKit())
							.insertHTML(
									hDoc,
									hDoc.getLength(),
									"<img src=\"http://upload.wikimedia.org/wikipedia/commons/e/ef/Curious_kitten.jpg\" /><br />",
									0, 0, null);
				}
				...
				else if (command.equals("asmexplorer"))
				{
					...
					plp.sim = new plptool.mips.SimCore((plptool.mips.Asm) plp.asm,
				...
				else if (command.equals("loaddmodclass"))
				{
					...
					if (retVal == javax.swing.JFileChooser.APPROVE_OPTION)
					{
						...
						plptool.dmf.DynamicModuleFramework.loadModuleClass(
								file.getAbsolutePath(),
								shortName.substring(0, shortName.length() - 6));
					}
				}
				else if (command.equals("listdmodclasses"))
				{
					Msg.M("Registered dynamic module classes:");
					for (int i = 0; i < plptool.dmf.DynamicModuleFramework
							.getNumberOfClasses(); i++)
					{
						Class c = plptool.dmf.DynamicModuleFramework
								.getDynamicModuleClass(i);
				...
				else if (command.equals("listdmods"))
				{
					...
					String prev = "";
					for (int i = 0; i < plptool.dmf.DynamicModuleFramework
							.getNumberOfModuleInstances(); i++)
					{
						prev = out.getText();
						out.setText(prev
								+ i
								+ ":\t"
								+ plptool.dmf.DynamicModuleFramework.getModuleInstance(i)
										.getClass().getName() + "\n");
					}
				}
				else if (command.equals("getarchlist"))
				{
					...
					for (int i = 0; i < archs.length; i++)
					{
						...
						Msg.I(id + ": " + c.getCanonicalName() + " \"" + strID + "\"",
								null);
					}
				...
				else if (command.startsWith("cmd "))
				{
					...
					if (t.length == 2)
						plptool.dmf.CallbackRegistry.callback(
								plptool.dmf.CallbackRegistry.COMMAND, t[1]);
				...
				else if (tokens.length > 1)
				{
					...
					{
						plptool.Config.devSyntaxHighlighting = Boolean
								.parseBoolean(tokens[1]);
						out.setText("cfgSyntaxHighlighting "
								+ plptool.Config.devSyntaxHighlighting);
					}
					...
					{
						out.setText("dmodclass index: "
								+ plptool.dmf.DynamicModuleFramework
										.isModuleClassRegistered(tokens[1]) + "\n");
					}
					else if (tokens[0].equals("newdmod") && tokens.length == 2)
					{
						out.setText("Instantiating new object for "
								+ plptool.dmf.DynamicModuleFramework
										.getDynamicModuleClass(
												PLPToolbox.parseNumInt(tokens[1]))
										.getName() + "\n");
						plptool.dmf.DynamicModuleFramework.newModuleInstance(PLPToolbox
								.parseNumInt(tokens[1]));
					}
					else if (tokens[0].equals("rmdmod") && tokens.length == 2)
					{
						plptool.dmf.DynamicModuleFramework
								.removeModuleInstance(PLPToolbox.parseNumInt(tokens[1]));
					}

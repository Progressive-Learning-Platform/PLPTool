...
public class TextLineHighlighter implements Highlighter.HighlightPainter
{
	...
	public void repaint()
	{
		txtEditor.repaint(0, yPos, txtEditor.getWidth(),
				txtEditor.getFontMetrics(txtEditor.getFont()).getHeight());
		
		if (old_yPos > -1)
		{
			txtEditor.repaint(0, old_yPos, txtEditor.getWidth(), txtEditor
					.getFontMetrics(txtEditor.getFont()).getHeight());
		}
	}
	
	public void paint(java.awt.Graphics g, int p0, int p1, java.awt.Shape bounds,
		...
		if (yPos > -1)
		{
			if (old_yPos > -1)
			{
				...
				y = old_yPos - txtEditor.getFontMetrics(txtEditor.getFont()).getHeight()
						+ txtEditor.getFontMetrics(txtEditor.getFont()).getDescent();
				g.setColor(Color.WHITE);
				g.fillRect(0, y, txtEditor.getWidth(),
						txtEditor.getFontMetrics(txtEditor.getFont()).getHeight());
			}

...
public class IORegistryFrame extends javax.swing.JFrame
{
	...
	private void reloadDynamicModuleLists()
	{
		...
		for (int i = 0; i < DynamicModuleFramework.getNumberOfClasses(); i++)
			cmbDModFrameClass.addItem(i + ":"
					+ DynamicModuleFramework.getDynamicModuleClass(i).getName());
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(IORegistryFrame.class);
		...
		cmbModuleSelect.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
		...
		paneAddLayout
				.setHorizontalGroup(paneAddLayout
						...
						.addGroup(
								...
								paneAddLayout
										...
										.addContainerGap()));
		paneAddLayout
				.setVerticalGroup(paneAddLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneAddLayout
										.createSequentialGroup()
		...
		jTabbedPane1.addTab(resourceMap.getString("addPane.TabConstraints.tabTitle"),
				paneAdd); // NOI18N
		...
		tblMods.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
		
		}, new String[] { "Name", "Index", "Bus Position", "Start Address",
				"End Address", "Show Frame" }) {
		...
		tblMods.getColumnModel().getColumn(0)
				.setHeaderValue(resourceMap.getString("tblMods.columnModel.title0")); // NOI18N
		tblMods.getColumnModel().getColumn(1)
				.setHeaderValue(resourceMap.getString("tblMods.columnModel.title5")); // NOI18N
		tblMods.getColumnModel().getColumn(2)
				.setHeaderValue(resourceMap.getString("tblMods.columnModel.title1")); // NOI18N
		tblMods.getColumnModel().getColumn(3)
				.setHeaderValue(resourceMap.getString("tblMods.columnModel.title3")); // NOI18N
		tblMods.getColumnModel().getColumn(4)
				.setHeaderValue(resourceMap.getString("tblMods.columnModel.title4")); // NOI18N
		tblMods.getColumnModel().getColumn(5)
				.setHeaderValue(resourceMap.getString("tblMods.columnModel.title5")); // NOI18N
		...
		paneListLayout
				.setHorizontalGroup(paneListLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								paneListLayout
										...
										.addContainerGap()));
		paneListLayout
				.setVerticalGroup(paneListLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								paneListLayout
		...
		jTabbedPane1.addTab(resourceMap.getString("paneList.TabConstraints.tabTitle"),
				paneList); // NOI18N
		...
		cmbPresets.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1",
		...
		javax.swing.GroupLayout paneIOConfigLayout = new javax.swing.GroupLayout(
				paneIOConfig);
		paneIOConfig.setLayout(paneIOConfigLayout);
		paneIOConfigLayout.setHorizontalGroup(paneIOConfigLayout.createParallelGroup(
				...
				paneIOConfigLayout
						...
						.addPreferredGap(
								javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(btnLoadPreset).addContainerGap()));
		paneIOConfigLayout
				.setVerticalGroup(paneIOConfigLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneIOConfigLayout
										.createSequentialGroup()
		...
		jTabbedPane1.addTab(
				resourceMap.getString("paneIOConfig.TabConstraints.tabTitle"),
				paneIOConfig); // NOI18N
		...
		cmbDModFrameClass.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
				"Item 1", "Item 2", "Item 3", "Item 4" }));
		...
		javax.swing.GroupLayout paneDynamicModulesLayout = new javax.swing.GroupLayout(
				paneDynamicModules);
		paneDynamicModules.setLayout(paneDynamicModulesLayout);
		paneDynamicModulesLayout
				.setHorizontalGroup(paneDynamicModulesLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneDynamicModulesLayout
										.createSequentialGroup()
										...
										.addContainerGap()));
		paneDynamicModulesLayout
				.setVerticalGroup(paneDynamicModulesLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneDynamicModulesLayout
										.createSequentialGroup()
		...
		jTabbedPane1.addTab(
				resourceMap.getString("paneDynamicModules.TabConstraints.tabTitle"),
				paneDynamicModules); // NOI18N
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup()
						.addContainerGap()
						.addComponent(jTabbedPane1, javax.swing.GroupLayout.DEFAULT_SIZE,
								482, Short.MAX_VALUE).addContainerGap()));
		
		pack();
	}// </editor-fold>//GEN-END:initComponents
	
	private void cmbModuleSelectActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_cmbModuleSelectActionPerformed
		if (modInfo != null && cmbModuleSelect.getSelectedIndex() >= 0)
		{
			...
			if (!(Boolean) modInfo[cmbModuleSelect.getSelectedIndex()][1])
			{
				...
				txtModuleRegfileSize.setText(""
						+ (Integer) modInfo[cmbModuleSelect.getSelectedIndex()][2]);
			}
			else
			{
	...
	{// GEN-FIRST:event_btnRemoveActionPerformed
		if (tblMods.getModel().getRowCount() > 0 && tblMods.getSelectedRow() > -1)
		{
			
			int index = (Integer) tblMods.getModel().getValueAt(tblMods.getSelectedRow(),
					1);
	...
	private void btnLoadPresetActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnLoadPresetActionPerformed
	...
	private void tblModsMouseClicked(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_tblModsMouseClicked
		try
		{
			...
			for (int row = 0; row < tblMods.getRowCount(); row++)
			{
				...
				{
					if (x != null && x instanceof javax.swing.JFrame
							&& !((javax.swing.JFrame) x).isVisible())
					{
	...
	private void btnReloadDModListActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnReloadDModListActionPerformed
		reloadDynamicModuleLists();
	}// GEN-LAST:event_btnReloadDModListActionPerformed
	
	private void btnAttachDModActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnAttachDModActionPerformed
		...
		{
			String[] modFrameEntry = ((String) cmbDModFrameClass.getSelectedItem())
					.split(":");
			modFrameClassIndex = Integer.parseInt(modFrameEntry[0]);
			frame = DynamicModuleFramework.newModuleInstance(modFrameClassIndex);
		}
		
		plp.ioreg.attachDynamicModule(modClassIndex, startAddr, endAddr,
				chkDModWordAligned.isSelected(), frame);
		refreshModulesTable();
	...
	public void refreshModulesTable()
	{
		...
		{
			javax.swing.JFrame frame = plp.ioreg.getModuleFrame(i) instanceof javax.swing.JFrame ? (javax.swing.JFrame) plp.ioreg
					.getModuleFrame(i) : null;
			Object row[] = new Object[] { modules[i].toString(), i,

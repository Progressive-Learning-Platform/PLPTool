...
public class ModuleManager extends javax.swing.JDialog
{
		...
		if (autoloadDir.exists() && autoloadDir.isDirectory())
		{
			...
			for (int i = 0; i < files.length; i++)
			{
				if (files[i].getName().endsWith(".jar"))
				{
					...
					row[1] = DynamicModuleFramework.getManifestEntry(
							files[i].getAbsolutePath(), "title");
					row[2] = DynamicModuleFramework.getManifestEntry(
							files[i].getAbsolutePath(), "version");
					tbl.addRow(row);
				}
			}
		...
		for (int i = 0; i < DynamicModuleFramework.getNumberOfModuleInstances(); i++)
		{
			...
			if (temp instanceof ModuleInterface5)
			{
				...
				for (int j = 0; j < mod.getVersion().length; j++)
					row[1] += mod.getVersion()[j]
							+ (j != mod.getVersion().length - 1 ? "." : "");
				row[2] = "" + i;
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(ModuleManager.class);
		...
		javax.swing.GroupLayout panelAutoloadLayout = new javax.swing.GroupLayout(
				panelAutoload);
		panelAutoload.setLayout(panelAutoloadLayout);
		panelAutoloadLayout
				.setHorizontalGroup(panelAutoloadLayout
						...
						.addGroup(
								panelAutoloadLayout
										...
										.addContainerGap()));
		panelAutoloadLayout
				.setVerticalGroup(panelAutoloadLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelAutoloadLayout
										.createSequentialGroup()
										...
										.addPreferredGap(
												javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(btnBrowse).addGap(18, 18, 18)));
		
		tabbedPane.addTab(resourceMap.getString("panelAutoload.TabConstraints.tabTitle"),
				panelAutoload); // NOI18N
		
		panelLoadedMods.setName("panelLoadedMods"); // NOI18N
		
		jScrollPane1.setName("jScrollPane1"); // NOI18N
		
		tblLoadedMods.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
				{ null, null, null }, { null, null, null }, { null, null, null },
				{ null, null, null } }, new String[] { "Name", "Version", "DMF Order" }) {
			Class[] types = new Class[] { java.lang.String.class, java.lang.String.class,
					java.lang.String.class };
			boolean[] canEdit = new boolean[] { false, false, false };
		...
		tblLoadedMods
				.getColumnModel()
				.getColumn(0)
				.setHeaderValue(resourceMap.getString("tblLoadedMods.columnModel.title0")); // NOI18N
		tblLoadedMods
				.getColumnModel()
				.getColumn(1)
				.setHeaderValue(resourceMap.getString("tblLoadedMods.columnModel.title1")); // NOI18N
		tblLoadedMods
				.getColumnModel()
				.getColumn(2)
				.setHeaderValue(resourceMap.getString("tblLoadedMods.columnModel.title2")); // NOI18N
		...
		javax.swing.GroupLayout panelLoadedModsLayout = new javax.swing.GroupLayout(
				panelLoadedMods);
		panelLoadedMods.setLayout(panelLoadedModsLayout);
		panelLoadedModsLayout
				.setHorizontalGroup(panelLoadedModsLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								panelLoadedModsLayout
										...
										.addContainerGap()));
		panelLoadedModsLayout
				.setVerticalGroup(panelLoadedModsLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								panelLoadedModsLayout
		...
		tabbedPane.addTab(
				resourceMap.getString("panelLoadedMods.TabConstraints.tabTitle"),
				panelLoadedMods); // NOI18N
		
		panelArchs.setName("panelArchs"); // NOI18N
		
		jScrollPane3.setName("jScrollPane3"); // NOI18N
		
		tblISAs.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
				{ null, null }, { null, null }, { null, null }, { null, null } },
				new String[] { "Title", "Arch ID" }) {
			Class[] types = new Class[] { java.lang.String.class, java.lang.String.class };
		...
		tblISAs.getColumnModel().getColumn(0)
				.setHeaderValue(resourceMap.getString("tblISAs.columnModel.title0")); // NOI18N
		tblISAs.getColumnModel().getColumn(1)
				.setHeaderValue(resourceMap.getString("tblISAs.columnModel.title1")); // NOI18N
		...
		panelArchsLayout
				.setHorizontalGroup(panelArchsLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								panelArchsLayout
										...
										.addContainerGap()));
		panelArchsLayout
				.setVerticalGroup(panelArchsLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								panelArchsLayout
		...
		tabbedPane.addTab(resourceMap.getString("panelArchs.TabConstraints.tabTitle"),
				panelArchs); // NOI18N
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(
										javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(btnClose).addComponent(btnRefresh))
						.addContainerGap()));
	...
	{// GEN-FIRST:event_btnBrowseActionPerformed
		...
		{
			if (PLPToolbox.downloadJARForAutoload("file:///"
					+ fc.getSelectedFile().getAbsolutePath(), null, false))
			{
				updateTable();
				retVal = JOptionPane.showConfirmDialog(this,
						"Would you like to load this module?", "Load Module",
	...
	{// GEN-FIRST:event_btnDeleteActionPerformed
		...
		if (index > -1)
		{
			String path = PLPToolbox.getConfDir() + "/autoload/"
					+ tblMods.getValueAt(index, 0);
	...
	{// GEN-FIRST:event_btnDownloadActionPerformed
	...
	private void tblLoadedModsMousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_tblLoadedModsMousePressed
		int i;
		if ((i = tblLoadedMods.getSelectedRow()) != -1)
		{
			// get DMF order
			ModuleInterface5 mod = (ModuleInterface5) DynamicModuleFramework
					.getModuleInstance(Integer.parseInt((String) tblLoadedMods
							.getValueAt(i, 2)));
	...
	private void tblISAsMousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_tblISAsMousePressed
		int i, ID;
		if ((i = tblISAs.getSelectedRow()) != -1)
		{
			...
			txtISAConnectorClass.setText(ArchRegistry.getRegisteredArchitectureClass(ID)
					.getCanonicalName());
		}

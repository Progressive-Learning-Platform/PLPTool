...
public class DynamicModuleManager extends javax.swing.JDialog
{
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(DynamicModuleManager.class);
		...
		tblModuleClasses.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
		
		}, new String[] { "Index", "Name", "Superclass" }) {
		...
		tblModuleClasses
				...
				.getColumn(0)
				.setHeaderValue(
						resourceMap.getString("tblModuleClasses.columnModel.title0")); // NOI18N
		tblModuleClasses
				.getColumnModel()
				.getColumn(1)
				.setHeaderValue(
						resourceMap.getString("tblModuleClasses.columnModel.title1")); // NOI18N
		tblModuleClasses
				.getColumnModel()
				.getColumn(2)
				.setHeaderValue(
						resourceMap.getString("tblModuleClasses.columnModel.title2")); // NOI18N
		...
		javax.swing.GroupLayout paneDynamicModuleClassesLayout = new javax.swing.GroupLayout(
				paneDynamicModuleClasses);
		paneDynamicModuleClasses.setLayout(paneDynamicModuleClassesLayout);
		paneDynamicModuleClassesLayout
				.setHorizontalGroup(paneDynamicModuleClassesLayout
						...
						.addGroup(
								paneDynamicModuleClassesLayout
										...
										.addContainerGap()));
		paneDynamicModuleClassesLayout
				.setVerticalGroup(paneDynamicModuleClassesLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneDynamicModuleClassesLayout
										.createSequentialGroup()
		...
		tabMain.addTab(
				resourceMap.getString("paneDynamicModuleClasses.TabConstraints.tabTitle"),
				paneDynamicModuleClasses); // NOI18N
		...
		tblCallbacks.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
		
		}, new String[] { "Order", "Class" }) {
		...
		tblCallbacks.getColumnModel().getColumn(0)
				.setHeaderValue(resourceMap.getString("tblCallbacks.columnModel.title0")); // NOI18N
		tblCallbacks.getColumnModel().getColumn(1)
				.setHeaderValue(resourceMap.getString("tblCallbacks.columnModel.title1")); // NOI18N
		
		javax.swing.GroupLayout paneRegisteredCallbacksLayout = new javax.swing.GroupLayout(
				paneRegisteredCallbacks);
		paneRegisteredCallbacks.setLayout(paneRegisteredCallbacksLayout);
		paneRegisteredCallbacksLayout
				.setHorizontalGroup(paneRegisteredCallbacksLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneRegisteredCallbacksLayout
										.createSequentialGroup()
										...
										.addContainerGap()));
		paneRegisteredCallbacksLayout
				.setVerticalGroup(paneRegisteredCallbacksLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneRegisteredCallbacksLayout
										.createSequentialGroup()
		...
		tabMain.addTab(
				resourceMap.getString("paneRegisteredCallbacks.TabConstraints.tabTitle"),
				paneRegisteredCallbacks); // NOI18N
		...
		btnEmbedManifestBrowse.setText(resourceMap
				.getString("btnEmbedManifestBrowse.text")); // NOI18N
		...
		txtEmbedManifestLicense.setText(resourceMap
				.getString("txtEmbedManifestLicense.text")); // NOI18N
		txtEmbedManifestLicense.setName("txtEmbedManifestLicense"); // NOI18N
		
		txtEmbedManifestAuthor.setText(resourceMap
				.getString("txtEmbedManifestAuthor.text")); // NOI18N
		txtEmbedManifestAuthor.setName("txtEmbedManifestAuthor"); // NOI18N
		
		txtEmbedManifestTitle
				.setText(resourceMap.getString("txtEmbedManifestTitle.text")); // NOI18N
		txtEmbedManifestTitle.setName("txtEmbedManifestTitle"); // NOI18N
		
		txtEmbedManifestVersion.setText(resourceMap
				.getString("txtEmbedManifestVersion.text")); // NOI18N
		...
		txtEmbedManifestDescription.setText(resourceMap
				.getString("txtEmbedManifestDescription.text")); // NOI18N
		txtEmbedManifestDescription.setName("txtEmbedManifestDescription"); // NOI18N
		
		javax.swing.GroupLayout paneEmbedManifestLayout = new javax.swing.GroupLayout(
				paneEmbedManifest);
		paneEmbedManifest.setLayout(paneEmbedManifestLayout);
		paneEmbedManifestLayout
				.setHorizontalGroup(paneEmbedManifestLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneEmbedManifestLayout
										.createSequentialGroup()
																		...
																		.addGroup(
																				paneEmbedManifestLayout
																						.createParallelGroup(
																								javax.swing.GroupLayout.Alignment.LEADING)
																						.addComponent(
																								txtEmbedManifestLicense,
																								javax.swing.GroupLayout.DEFAULT_SIZE,
																								510,
																								Short.MAX_VALUE)
																						.addComponent(
																								txtEmbedManifestAuthor,
																								javax.swing.GroupLayout.DEFAULT_SIZE,
																								510,
																								Short.MAX_VALUE)
																						.addComponent(
										...
										.addContainerGap()));
		paneEmbedManifestLayout
				.setVerticalGroup(paneEmbedManifestLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneEmbedManifestLayout
										.createSequentialGroup()
		...
		tabMain.addTab(
				resourceMap.getString("paneEmbedManifest.TabConstraints.tabTitle"),
				paneEmbedManifest); // NOI18N
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup()
						.addContainerGap()
						.addComponent(tabMain, javax.swing.GroupLayout.DEFAULT_SIZE, 501,
								Short.MAX_VALUE)
						.addPreferredGap(
								javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(
								layout.createParallelGroup(
										javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(btnClose).addComponent(jLabel5))
						.addContainerGap()));
	...
	private void updateClassList()
	{
		...
		for (int i = 0; i < DynamicModuleFramework.getNumberOfClasses(); i++)
		{
			...
			sC = c.getSuperclass();
			Object[] row = { i, c.getName(),
					sC != null ? c.getSuperclass().getName() : "N/A" };
			tbl.addRow(row);
		}
	}
	
	private void btnBrowseClassActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnBrowseClassActionPerformed
	...
	private void btnRegisterClassActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnRegisterClassActionPerformed
		String className = txtClassName.getText();
		if (className.equals("*"))
			DynamicModuleFramework.loadAllFromJar(txtClassFile.getText());
		else
			DynamicModuleFramework.loadModuleClass(txtClassFile.getText(),
	...
	private void cmbCallbackEventMousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_cmbCallbackEventMousePressed
	
	}// GEN-LAST:event_cmbCallbackEventMousePressed
	
	private void cmbCallbackEventActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_cmbCallbackEventActionPerformed
		if (cmbCallbackEvent.getSelectedIndex() > -1)
		{
			DefaultTableModel tbl = (DefaultTableModel) tblCallbacks.getModel();
			while (tbl.getRowCount() > 0)
				tbl.removeRow(0);
			Object[] callbacks = CallbackRegistry.getCallbacks(cmbCallbackEvent
					.getSelectedIndex());
	...
	private void btnEmbedManifestBrowseActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnEmbedManifestBrowseActionPerformed
	...
	private void btnEmbedManifestActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnEmbedManifestActionPerformed
		int ret;
		...
		if (manifest != null)
		{
			ret = PLPToolbox.addToJar(txtEmbedManifestJAR.getText(), "plp.manifest",
					manifest.getBytes());

...
public class FindAndReplace extends javax.swing.JFrame
{
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(FindAndReplace.class);
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(
										javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(btnGo).addComponent(btnReplaceAll)
										.addComponent(btnClose))
	...
	{// GEN-FIRST:event_btnGoActionPerformed
	...
	private void txtFindKeyPressed(java.awt.event.KeyEvent evt)
	{// GEN-FIRST:event_txtFindKeyPressed
	...
	{// GEN-FIRST:event_btnReplaceAllActionPerformed
		curIndex = 0;
		int caret;
		int replaceCount = 0;
		while ((caret = plp.g_dev.getEditor().getText()
				.indexOf(txtFind.getText(), curIndex)) > -1)
		{
			plp.g_dev.getEditor().setCaretPosition(caret);
			plp.g_dev.getEditor().setSelectionStart(caret);
			plp.g_dev.getEditor().setSelectionEnd(caret + txtFind.getText().length());
	...
	private void txtReplaceFocusGained(java.awt.event.FocusEvent evt)
	{// GEN-FIRST:event_txtReplaceFocusGained
		txtReplace.setSelectionStart(0);
		txtReplace.setSelectionEnd(txtReplace.getText().length());
	}// GEN-LAST:event_txtReplaceFocusGained
	
	private void txtFindFocusGained(java.awt.event.FocusEvent evt)
	{// GEN-FIRST:event_txtFindFocusGained

...
public class OptionsFrame extends javax.swing.JFrame
{
	...
	private void apply()
	{
		...
		{
			Config.devFontSize = (Integer) cmbFontSize.getItemAt(cmbFontSize
					.getSelectedIndex());
			plp.g_dev.changeFormatting();
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(OptionsFrame.class);
		...
		editorSyntaxHighlighting.setText(resourceMap
				.getString("editorSyntaxHighlighting.text")); // NOI18N
		...
		cmbFontName.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
		...
		paneEditorLayout
				.setHorizontalGroup(paneEditorLayout
						...
						.addGroup(
								paneEditorLayout
										...
										.addContainerGap()));
		paneEditorLayout
				.setVerticalGroup(paneEditorLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneEditorLayout
										.createSequentialGroup()
		...
		tabsOptions.addTab(resourceMap.getString("paneEditor.TabConstraints.tabTitle"),
				paneEditor); // NOI18N
		...
		simBusReadDefaultZero
				.setText(resourceMap.getString("simBusReadDefaultZero.text")); // NOI18N
		...
		simDumpTraceOnFailedEval.setText(resourceMap
				.getString("simDumpTraceOnFailedEval.text")); // NOI18N
		...
		paneSimLayout
				.setHorizontalGroup(paneSimLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneSimLayout
										.createSequentialGroup()
										...
										.addContainerGap()));
		paneSimLayout.setVerticalGroup(paneSimLayout.createParallelGroup(
				...
				paneSimLayout
						...
						.addPreferredGap(
								javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(sSimSpeed, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18)
						.addComponent(simNoExecute)
		...
		tabsOptions.addTab(resourceMap.getString("paneSim.TabConstraints.tabTitle"),
				paneSim); // NOI18N
		...
		javax.swing.GroupLayout paneProgrammerLayout = new javax.swing.GroupLayout(
				paneProgrammer);
		paneProgrammer.setLayout(paneProgrammerLayout);
		paneProgrammerLayout
				.setHorizontalGroup(paneProgrammerLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneProgrammerLayout
										.createSequentialGroup()
										...
										.addContainerGap()));
		paneProgrammerLayout
				.setVerticalGroup(paneProgrammerLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneProgrammerLayout
										.createSequentialGroup()
										...
										.addGroup(
												paneProgrammerLayout
														...
														.addComponent(
																...
																javax.swing.GroupLayout.DEFAULT_SIZE,
																javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGap(18, 18, 18).addComponent(lblPrgWarning)
										.addGap(18, 18, 18)
										.addComponent(prgAutoDetectPorts)
										.addContainerGap(245, Short.MAX_VALUE)));
		
		tabsOptions.addTab(
				resourceMap.getString("paneProgrammer.TabConstraints.tabTitle"),
				paneProgrammer); // NOI18N
		
		paneExtensions.setName("paneExtensions"); // NOI18N
		
		askBeforeAutoloadingModules.setText(resourceMap
				.getString("askBeforeAutoloadingModules.text")); // NOI18N
		askBeforeAutoloadingModules.setName("askBeforeAutoloadingModules"); // NOI18N
		askBeforeAutoloadingModules
		...
		askForISAForNewProjects.setText(resourceMap
				.getString("askForISAForNewProjects.text")); // NOI18N
		...
		javax.swing.GroupLayout paneExtensionsLayout = new javax.swing.GroupLayout(
				paneExtensions);
		paneExtensions.setLayout(paneExtensionsLayout);
		paneExtensionsLayout
				.setHorizontalGroup(paneExtensionsLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								paneExtensionsLayout
										.createSequentialGroup()
										...
										.addGroup(
												paneExtensionsLayout
														...
														.addComponent(
																askBeforeAutoloadingModules)
														.addComponent(
																askForISAForNewProjects))
										.addContainerGap(213, Short.MAX_VALUE)));
		paneExtensionsLayout.setVerticalGroup(paneExtensionsLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				paneExtensionsLayout
						.createSequentialGroup()
						.addContainerGap()
		...
		tabsOptions.addTab(
				resourceMap.getString("paneExtensions.TabConstraints.tabTitle"),
				paneExtensions); // NOI18N
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(
										javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(btnClose).addComponent(btnApply))
						.addContainerGap(15, Short.MAX_VALUE)));
		
		tabsOptions.getAccessibleContext().setAccessibleName(
				resourceMap.getString("tabsOptions.AccessibleContext.accessibleName")); // NOI18N
		
		pack();
	}// </editor-fold>//GEN-END:initComponents
	
	private void sSimSpeedStateChanged(javax.swing.event.ChangeEvent evt)
	{// GEN-FIRST:event_sSimSpeedStateChanged
		triggerChange();
	...
	private void simNoExecuteActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_simNoExecuteActionPerformed
		triggerChange();
	}// GEN-LAST:event_simNoExecuteActionPerformed
	
	private void simBusReadDefaultZeroActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_simBusReadDefaultZeroActionPerformed
		triggerChange();
	}// GEN-LAST:event_simBusReadDefaultZeroActionPerformed
	
	private void simDumpTraceOnFailedEvalActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_simDumpTraceOnFailedEvalActionPerformed
		triggerChange();
	}// GEN-LAST:event_simDumpTraceOnFailedEvalActionPerformed
	
	private void editorSyntaxHighlightingActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_editorSyntaxHighlightingActionPerformed
		triggerChange();
		
	}// GEN-LAST:event_editorSyntaxHighlightingActionPerformed
	
	private void cmbFontSizePropertyChange(java.beans.PropertyChangeEvent evt)
	{// GEN-FIRST:event_cmbFontSizePropertyChange
	
	}// GEN-LAST:event_cmbFontSizePropertyChange
	
	private void cmbFontSizeActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_cmbFontSizeActionPerformed
		txtFontPreview.setFont(new Font(txtFontPreview.getFont().getName(), Font.PLAIN,
				(Integer) cmbFontSize.getSelectedItem()));
		triggerChange();
	}// GEN-LAST:event_cmbFontSizeActionPerformed
	
	private void simRefreshDevActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_simRefreshDevActionPerformed
		triggerChange();
	}// GEN-LAST:event_simRefreshDevActionPerformed
	
	private void prgProgramInChunksActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_prgProgramInChunksActionPerformed
		triggerChange();
	...
	private void prgMaxChunkSizeKeyPressed(java.awt.event.KeyEvent evt)
	{// GEN-FIRST:event_prgMaxChunkSizeKeyPressed
		triggerChange();
	}// GEN-LAST:event_prgMaxChunkSizeKeyPressed
	
	private void prgReadTimeoutKeyPressed(java.awt.event.KeyEvent evt)
	{// GEN-FIRST:event_prgReadTimeoutKeyPressed
		triggerChange();
	}// GEN-LAST:event_prgReadTimeoutKeyPressed
	
	private void simHighlightLineActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_simHighlightLineActionPerformed
		triggerChange();
	}// GEN-LAST:event_simHighlightLineActionPerformed
	
	private void simFunctionalActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_simFunctionalActionPerformed
		triggerChange();
		if (plp.isSimulating())
			Msg.W("The simulation may need to be restarted.", null);
	}// GEN-LAST:event_simFunctionalActionPerformed
	
	private void cmbFontNameActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_cmbFontNameActionPerformed
		txtFontPreview.setFont(new Font((String) cmbFontName.getSelectedItem(),
				Font.PLAIN, txtFontPreview.getFont().getSize()));
		triggerChange();
	}// GEN-LAST:event_cmbFontNameActionPerformed
	
	private void askBeforeAutoloadingModulesActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_askBeforeAutoloadingModulesActionPerformed
		triggerChange();
	}// GEN-LAST:event_askBeforeAutoloadingModulesActionPerformed
	
	private void askForISAForNewProjectsActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_askForISAForNewProjectsActionPerformed
		triggerChange();
	}// GEN-LAST:event_askForISAForNewProjectsActionPerformed
	
	private void prgAutoDetectPortsActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_prgAutoDetectPortsActionPerformed
		triggerChange();

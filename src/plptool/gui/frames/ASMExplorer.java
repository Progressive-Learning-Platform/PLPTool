...
public class ASMExplorer extends javax.swing.JFrame
{
		...
		for (int i = 0; i < objCode.length; i++)
		{
			Object[] row = new Object[] {
					String.format("0x%08x", plp.asm.getAddrTable()[i])
							+ " "
							+ ((plp.sim != null) ? ((((plptool.mips.SimCore) plp.sim).pc
									.eval() == plp.asm.getAddrTable()[i]) ? "[PC]" : "")
									: ""),
					String.format("0x%08x", objCode[i]),
					plp.asm.getAsmList().get(plp.asm.getFileMapper()[i]).getAsmFilePath(),
					plp.asm.getLineNumMapper()[i],
					plp.asm.getAsmList().get(plp.asm.getFileMapper()[i])
							.getAsmLine(plp.asm.getLineNumMapper()[i]) };
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(ASMExplorer.class);
		...
		tblASM.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
				...
				{ null, null, null, null, null }, { null, null, null, null, null } },
				new String[] { "Addr", "Instr", "File", "Line #", "LineStr" }) {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(scrlTblASM,

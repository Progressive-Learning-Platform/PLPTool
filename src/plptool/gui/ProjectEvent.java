...
/**
 * Project event. Some actions in PLPTool will pass an instance of this class to the hook
 * function of all loaded dynamic modules.
 *
 * @author wira
 */
public class ProjectEvent
{
	...
	/**
	 * This constructor specifies the ID, timestamp, and parameters of the event
	 *
	 * @param id
	 *            Numeric identifier of the event
	 * @param timestamp
	 *            User-defined timestamp of when the event occurred
	 * @param parameters
	 *            Other parameters of the event
	 */
	...
	/**
	 * This constructor specifies only ID and timestamp of the event. The parameters field
	 * is set to null.
	 *
	 * @param id
	 *            Numeric identifier of the event
	 ...
	 *
	 * @param params
	 *            Generic object reference of the parameters
	 */

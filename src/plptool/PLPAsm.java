...
public abstract class PLPAsm
{
	...
	/**
	 * Entry point to the assembled program to be optionally used by the rest of the
	 * framework
	 */
	protected long entryPoint;
	
	/**
	 * First pass string builder. Use this object for faster string manipulation such as
	 * appending preprocessed text
	 */
	...
	/**
	 * An array list of build error objects that can be used to relate back to the source
	 * file index and the line number where the source of the error is
	 */
	protected ArrayList<PLPBuildError> errorList;
	
	/**
	 * PLPAsm defaults to returning the current version of PLPTool. User assemblers can
	 * override this. May be useful for dynamic modules
	 *
	...
	/**
	 * Constructor for the assembler object that takes a string of assembly and
	 * informational assembly file path. This constructor will create and populate the
	 * source list with one assembly source
	 *
	 * @param strAsm
	 *            Source string
	 * @param strFilePath
	...
	/**
	 * Constructor for the assembler object that takes an arraylist of PLPAsmSource
	 * objects
	 *
	 * @param asms
	 *            List ouf assembly sources
	 */
	...
	/**
	 * The region of which each object code entry belongs to. This is implementation
	 * specific and used by the linker to generate final program.
	 */
	 ...
	 *
	 * @param index
	 *            Source file index to start preprocess with
	...
	/**
	 * Append the preprocessed assembly string. This method also updates the assembly file
	 * and line number mapping for error reporting purposes.
	 *
	 * @param index
	 *            The 'preprocessed assembly' line number.
	 * @param str
	 *            Text to add to the string.
	 * @param lineNum
	 *            The line number of the assembly file currently being preprocessed.
	 */
	...
	/**
	 * Get the file mapper array. The index of the array is where the object code is
	 * stored in the object code array. The value is the source file ID when assembly was
	 * done.
	 *
	...
	/**
	 * Get the line number array. The index of the array is where the object code is
	 * stored in the object code array. The value is the line number where this
	 * instruction came from.
	 *
	 * @return An array mapping the object code index to the source file line number
	 */
	...
	/**
	 * Get the index of the source file where the instruction specified by the address
	 * came from.
	 *
	 * @param addr
	...
	/**
	 * Get the line number of the code where the instruction specified by the address came
	 * from
	 *
	 * @param addr
	 *            Address of the instruction
	 ...
	 * @return The address of the resulting instruction, or -1 if the search fails
	 */
	...
	/**
	 * This variable describes the state of the asm sources attached to this assembler.
	 * This variable is set true when all assembly sources were successfully assembled and
	 * objectCode[], addrtable[] and symTable are populated.
	 */
	protected boolean assembled;
	
	/**
	 * Lookup if the provided memory address has a label attached to it in the symbol
	 * table.
	 *
	 * @return Returns the label in String if found, null otherwise
	 * @param address
	 *            memory address to look up
	 */
	 ...
	 * @param label
	 *            Label to look up
	 * @return The address associated with the label, or PLP_ERROR_RETURN if it's not in
	 *         the symtable
	 */
	...
	/**
	 * Return the index associated with the given address. Can be used to trace back an
	 * address to the source file
	 *
	 * @param addr
	 *            Address to look up
	...
	/**
	 * Return whether the source files attached to this assembler have been successfully
	 * assembled.
	 *
	 * @return Returns boolean true if all sources are assembled, false otherwise
	 */
	...
	/**
	 * Other ISA-specific checks that the develop may wish to do. Any return value other
	 * than PLP_OK will prevent the start of the simulation
	 *

...
/**
 * This class represents an error that occurred during a build process of a program
 * (either with an assembler or compiler). The assembler abstract maintains a list of this
 * class' objects so a user interface can relate the errors back to the source files.
 *
 * @author Wira
 */
public class PLPBuildError
{
	...
	/**
	 * The constructor for the class takes the index of the source file, the line number
	 * of where the offending expression is in the file, and the error message emitted by
	 * the build tool
	 *
	 * @param index
	 *            Index of the source file
	 * @param number
	 *            Line number where the source of the error is
	 * @param message

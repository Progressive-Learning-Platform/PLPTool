...
public class SwitchesFrame extends javax.swing.JFrame
{
	...
	public SwitchesFrame(Switches module)
	{
		...
		this.setIconImage(java.awt.Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("resources/toolbar_sim_switches.png")));
		initComponents();
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(SwitchesFrame.class);
								...
								.addGroup(
										layout.createParallelGroup(
												...
												.addGroup(
														...
														layout.createSequentialGroup()
																.addComponent(bit7, 0, 0,
																		Short.MAX_VALUE)
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																.addComponent(bit6, 0, 0,
																		Short.MAX_VALUE)
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																.addComponent(bit5, 0, 0,
																		Short.MAX_VALUE)
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																.addComponent(bit4, 0, 0,
																		Short.MAX_VALUE)
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																.addComponent(bit3, 0, 0,
																		Short.MAX_VALUE)
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																.addComponent(bit2, 0, 0,
																		Short.MAX_VALUE)
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																.addComponent(bit1, 0, 0,
																		Short.MAX_VALUE)
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																.addComponent(bit0, 0, 0,
																		Short.MAX_VALUE)))
								.addContainerGap()));
	...
	private void bit0ActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_bit0ActionPerformed
		eval();
	}// GEN-LAST:event_bit0ActionPerformed
	
	private void bit1ActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_bit1ActionPerformed
		eval();
	}// GEN-LAST:event_bit1ActionPerformed
	
	private void bit2ActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_bit2ActionPerformed
		eval();
	}// GEN-LAST:event_bit2ActionPerformed
	
	private void bit3ActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_bit3ActionPerformed
		eval();
	}// GEN-LAST:event_bit3ActionPerformed
	
	private void bit4ActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_bit4ActionPerformed
		eval();
	}// GEN-LAST:event_bit4ActionPerformed
	
	private void bit5ActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_bit5ActionPerformed
		eval();
	}// GEN-LAST:event_bit5ActionPerformed
	
	private void bit6ActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_bit6ActionPerformed
		eval();
	}// GEN-LAST:event_bit6ActionPerformed
	
	private void bit7ActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_bit7ActionPerformed
		eval();

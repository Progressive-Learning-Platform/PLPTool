...
public class BusMonitorFrame extends javax.swing.JFrame
{
	...
	public BusMonitorFrame(BusMonitor busMon, final JCheckBoxMenuItem menu)
	{
		...
		this.setIconImage(java.awt.Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("resources/timingdiagram.png")));
		this.busMon = busMon;
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(BusMonitorFrame.class);
		setTitle(resourceMap.getString("Form.title")); // NOI18N
		setName("Form"); // NOI18N
		
		canvasContainer.setName("canvasContainer"); // NOI18N
		
		javax.swing.GroupLayout canvasContainerLayout = new javax.swing.GroupLayout(
				canvasContainer);
		canvasContainer.setLayout(canvasContainerLayout);
		canvasContainerLayout.setHorizontalGroup(canvasContainerLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0,
						638, Short.MAX_VALUE));
		canvasContainerLayout.setVerticalGroup(canvasContainerLayout.createParallelGroup(
												...
												.addGroup(
														layout.createSequentialGroup()
																...
																.addComponent(
																		btnShiftRight)))
								.addContainerGap())
				.addComponent(canvasContainer, javax.swing.GroupLayout.DEFAULT_SIZE,
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(
										...
										.addComponent(btnZoomIn).addComponent(btnZoomOut)
						...
						.addGroup(
								layout.createParallelGroup(
										...
										.addComponent(chkDeltaCursor)).addContainerGap()));
		
		pack();
	}// </editor-fold>//GEN-END:initComponents
	
	private void btnSimEndCopyActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnSimEndCopyActionPerformed
	...
	private void btnAddLocationActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnAddLocationActionPerformed
	...
	{// GEN-FIRST:event_btnZoomInActionPerformed
		canvas.doZoomInOnCursor(2.0);
		updateRangeFields();
	}// GEN-LAST:event_btnZoomInActionPerformed
	
	private void btnZoomOutActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnZoomOutActionPerformed
		canvas.doZoomOutOnCursor(2.0);
		updateRangeFields();
	}// GEN-LAST:event_btnZoomOutActionPerformed
	
	private void btnCursorToStartActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnCursorToStartActionPerformed
	...
	private void btnCursorToEndActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnCursorToEndActionPerformed
		double cur = canvas.getYCursorTime() + axis.getDomainStart();
		if (cur >= 0)
		{
	...
	private void btnShiftLeftActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnShiftLeftActionPerformed
		canvas.doLeftShift(0.10);
		updateRangeFields();
	}// GEN-LAST:event_btnShiftLeftActionPerformed
	
	private void btnShiftRightActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_btnShiftRightActionPerformed
		canvas.doRightShift(0.10);
		updateRangeFields();
	}// GEN-LAST:event_btnShiftRightActionPerformed
	
	private void chkDeltaCursorActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_chkDeltaCursorActionPerformed
	...
	private void txtLocationKeyPressed(java.awt.event.KeyEvent evt)
	{// GEN-FIRST:event_txtLocationKeyPressed

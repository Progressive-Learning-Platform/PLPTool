...
/**
 * Presets for I/O registry. This class is used to preserve bus modules states on the
 * project.
 *
 * @author wira
 */
public class Preset
{
	...
	public void addModuleDefinition(int type, long startAddr, long size, boolean frame,
			boolean visible, int X, int Y, int W, int H)
	{
		types.add(type);
	...
	public final static Object[][] presets = new Object[][] {
			/**********************************************************************/
			{
					...
					new Long[] { 0x0L, 0x10000000L, 0xf0200000L, 0xf0100000L,
							0xf0500000L, 0xf0600000L, 0xf0a00000L, 0xf0000000L,
							0xf0400000L, 0xf0300000L },
					
					new Long[] { 0x800L, 0x1000000L, 1L, 1L, 2L, 1L, 1L, 4L, 2L, 3L } },
			...
			new Long[] { 0x0L, 0x10000000L },
			
			new Long[] { 0x800L, 0x1000000L } },
			...
			/**********************************************************************/
			{
					...
					new Long[] { 0xf0200000L, 0xf0100000L, 0xf0500000L, 0xf0600000L,
							0xf0a00000L, 0xf0000000L, 0xf0400000L, 0xf0300000L },
					
					new Long[] { 1L, 1L, 2L, 1L, 1L, 4L, 2L, 3L } },

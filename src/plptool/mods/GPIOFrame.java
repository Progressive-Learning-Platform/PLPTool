...
public class GPIOFrame extends javax.swing.JFrame
{
	...
	public GPIOFrame(GPIO mod)
	{
		this.setIconImage(java.awt.Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("resources/toolbar_sim_gpio.png")));
		initComponents();
		this.mod = mod;
		this.setTitle("GPIO Module at " + PLPToolbox.format32Hex(mod.startAddr()));
		
		gpio_in_low = new ImageIcon(java.awt.Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("resources/gpio_in_low.png")));
		gpio_in_high = new ImageIcon(java.awt.Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("resources/gpio_input.png")));
		gpio_out_low = new ImageIcon(java.awt.Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("resources/gpio_out_low.png")));
		gpio_out_high = new ImageIcon(java.awt.Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("resources/gpio_output.png")));
	}
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(GPIOFrame.class);
	...
	private void A7MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_A7MousePressed
		updateModuleRegisters(7);
	}// GEN-LAST:event_A7MousePressed
	
	private void A6MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_A6MousePressed
		updateModuleRegisters(6);
	}// GEN-LAST:event_A6MousePressed
	
	private void A5MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_A5MousePressed
		updateModuleRegisters(5);
	}// GEN-LAST:event_A5MousePressed
	
	private void A4MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_A4MousePressed
		updateModuleRegisters(4);
	}// GEN-LAST:event_A4MousePressed
	
	private void A3MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_A3MousePressed
		updateModuleRegisters(3);
	}// GEN-LAST:event_A3MousePressed
	
	private void A2MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_A2MousePressed
		updateModuleRegisters(2);
	}// GEN-LAST:event_A2MousePressed
	
	private void A1MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_A1MousePressed
		updateModuleRegisters(1);
	}// GEN-LAST:event_A1MousePressed
	
	private void A0MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_A0MousePressed
		updateModuleRegisters(0);
	}// GEN-LAST:event_A0MousePressed
	
	private void B0MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_B0MousePressed
		updateModuleRegisters(8);
	}// GEN-LAST:event_B0MousePressed
	
	private void B1MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_B1MousePressed
		updateModuleRegisters(9);
	}// GEN-LAST:event_B1MousePressed
	
	private void B2MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_B2MousePressed
		updateModuleRegisters(10);
	}// GEN-LAST:event_B2MousePressed
	
	private void B3MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_B3MousePressed
		updateModuleRegisters(11);
	}// GEN-LAST:event_B3MousePressed
	
	private void B4MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_B4MousePressed
		updateModuleRegisters(12);
	}// GEN-LAST:event_B4MousePressed
	
	private void B5MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_B5MousePressed
		updateModuleRegisters(13);
	}// GEN-LAST:event_B5MousePressed
	
	private void B6MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_B6MousePressed
		updateModuleRegisters(14);
	}// GEN-LAST:event_B6MousePressed
	
	private void B7MousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_B7MousePressed

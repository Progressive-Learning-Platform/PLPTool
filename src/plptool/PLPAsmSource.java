...
/**
 * This class implements an assembly source and its data structures used by PLPAssembler.
 *
 * @author wira
 */
...
public class PLPAsmSource
{
	...
	public PLPAsmSource(String strAsm, String strFilePath, int intLevel)
	{
		...
		{
			Msg.E("Error reading file", Constants.PLP_GENERIC_ERROR, this);
		}
	}
	...
	public String getAsmLine(int lineNum)
	{
		...
		{
			Msg.E("Invalid line number: " + lineNum, Constants.PLP_ASM_INVALID_LINENUM,
					this);
			return null;
		}

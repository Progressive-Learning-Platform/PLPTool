...
public abstract class PLPSimCore
{
	...
	/**
	 * Simulation flags. This flag is used by various modules to indicate whether certain
	 * events have occured.
	 */
	...
	/**
	 * PLPSimCore defaults to returning the current version of PLPTool. User simcores can
	...
	/**
	 * Simulator application will call this program when it instantiates a simulation
	 * core.
	 */
	abstract public int loadProgram(PLPAsm asm);
	
	/**
	 * Wrapper for the step handler. This is the actual method called by the framework
	 *
	 * @return
	 */
	public int stepW()
	...
	public class mod_breakpoint
	{
		 ...
		 *
		 * @param addr
		 *            The address of the program to break on
		 * @param fileMap
		 *            File mapper for GUI purposes
		 * @param lineNumMap
		 *            File number mapper for GUI purposes
		 */
		 ...
		 *
		 * @param fIndex
		 *            The file mapper index for the file in question
		 * @param lineNum
		 ...
		 *
		 * @param index
		 *            Index of breakpoint to be removed

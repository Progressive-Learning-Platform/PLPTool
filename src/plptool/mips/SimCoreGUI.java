...
public class SimCoreGUI extends plptool.PLPSimCoreGUI
{
	...
	public SimCoreGUI(plptool.gui.ProjectDriver plp)
	{
		...
		this.setIconImage(java.awt.Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("resources/toolbar_cpu.png")));
		...
		if (attrSet != null)
		{
			plptool.Msg.D("we have " + attrSet.length
					+ " memory visualizers saved in project driver.", 4, this);
			
			for (int i = 0; i < attrSet.length; i++)
			{
				plptool.Msg.D(
						"attaching memory visualizer "
								+ String.format("(%08x-%08x)", attrSet[i][0],
										attrSet[i][1]), 3, this);
	...
	private void initComponents()
	{
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(SimCoreGUI.class);
		...
		javax.swing.GroupLayout coreVisPaneLayout = new javax.swing.GroupLayout(
				coreVisPane);
		coreVisPane.setLayout(coreVisPaneLayout);
		coreVisPaneLayout.setHorizontalGroup(coreVisPaneLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				coreVisPaneLayout.createSequentialGroup().addContainerGap()
						.addComponent(lblVis).addContainerGap(805, Short.MAX_VALUE)));
		coreVisPaneLayout.setVerticalGroup(coreVisPaneLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				coreVisPaneLayout.createSequentialGroup().addContainerGap()
						.addComponent(lblVis).addContainerGap(431, Short.MAX_VALUE)));
		
		coreMainPane.addTab(resourceMap.getString("coreVisPane.TabConstraints.tabTitle"),
				coreVisPane); // NOI18N
		...
		tblRegFile.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
				...
				{ null, null, null }, { null, null, null }, { null, null, null },
				{ null, null, null }, { null, null, null }, { null, null, null },
				{ null, null, null }, { null, null, null } }, new String[] { "Register",
		...
		tblRegFile.getColumnModel().getSelectionModel()
				.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
		tblRegFile.getColumnModel().getColumn(0).setResizable(false);
		tblRegFile.getColumnModel().getColumn(0)
				.setHeaderValue(resourceMap.getString("tblRegFile.columnModel.title0")); // NOI18N
		tblRegFile.getColumnModel().getColumn(1)
				.setHeaderValue(resourceMap.getString("tblRegFile.columnModel.title1")); // NOI18N
		tblRegFile.getColumnModel().getColumn(2)
				.setHeaderValue(resourceMap.getString("tblRegFile.columnModel.title2")); // NOI18N
		
		javax.swing.GroupLayout coreRegFilePaneLayout = new javax.swing.GroupLayout(
				coreRegFilePane);
		coreRegFilePane.setLayout(coreRegFilePaneLayout);
		coreRegFilePaneLayout.setHorizontalGroup(coreRegFilePaneLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
						coreRegFilePaneLayout
								.createSequentialGroup()
								.addContainerGap()
								.addComponent(jScrollPane1,
										javax.swing.GroupLayout.DEFAULT_SIZE, 1023,
										Short.MAX_VALUE).addContainerGap()));
		coreRegFilePaneLayout.setVerticalGroup(coreRegFilePaneLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				coreRegFilePaneLayout
						.createSequentialGroup()
						.addContainerGap()
						.addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE,
								434, Short.MAX_VALUE).addContainerGap()));
		
		coreMainPane.addTab(
				resourceMap.getString("coreRegFilePane.TabConstraints.tabTitle"),
				coreRegFilePane); // NOI18N
		...
		tblProgram.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
		
		}, new String[] { "PC", "Breakpoint", "Address", "Instruction (Hex)",
				"Instruction" }) {
		...
		tblProgram.getColumnModel().getColumn(0)
				.setHeaderValue(resourceMap.getString("tblProgram.columnModel.title0")); // NOI18N
		tblProgram.getColumnModel().getColumn(1)
				.setHeaderValue(resourceMap.getString("tblProgram.columnModel.title1")); // NOI18N
		tblProgram.getColumnModel().getColumn(2)
				.setHeaderValue(resourceMap.getString("tblProgram.columnModel.title2")); // NOI18N
		tblProgram.getColumnModel().getColumn(3)
				.setHeaderValue(resourceMap.getString("tblProgram.columnModel.title3")); // NOI18N
		tblProgram.getColumnModel().getColumn(4)
				.setHeaderValue(resourceMap.getString("tblProgram.columnModel.title4")); // NOI18N
		
		javax.swing.GroupLayout coreProgramPaneLayout = new javax.swing.GroupLayout(
				coreProgramPane);
		coreProgramPane.setLayout(coreProgramPaneLayout);
		coreProgramPaneLayout.setHorizontalGroup(coreProgramPaneLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
						coreProgramPaneLayout
								.createSequentialGroup()
								.addContainerGap()
								.addComponent(jScrollPane3,
										javax.swing.GroupLayout.DEFAULT_SIZE, 1023,
										Short.MAX_VALUE).addContainerGap()));
		coreProgramPaneLayout.setVerticalGroup(coreProgramPaneLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				coreProgramPaneLayout
						.createSequentialGroup()
						.addContainerGap()
		...
		coreMainPane.addTab(
				resourceMap.getString("coreProgramPane.TabConstraints.tabTitle"),
				coreProgramPane); // NOI18N
		...
		tblMemMap.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
		
		}, new String[] { "Index", "Module Name", "Start Address", "End Address",
				"Enabled" }) {
		...
		tblMemMap.getColumnModel().getColumn(0)
				.setHeaderValue(resourceMap.getString("tblMemMap.columnModel.title0")); // NOI18N
		tblMemMap.getColumnModel().getColumn(1)
				.setHeaderValue(resourceMap.getString("tblMemMap.columnModel.title1")); // NOI18N
		tblMemMap.getColumnModel().getColumn(2)
				.setHeaderValue(resourceMap.getString("tblMemMap.columnModel.title2")); // NOI18N
		tblMemMap.getColumnModel().getColumn(3)
				.setHeaderValue(resourceMap.getString("tblMemMap.columnModel.title3")); // NOI18N
		tblMemMap.getColumnModel().getColumn(4)
				.setHeaderValue(resourceMap.getString("tblMemMap.columnModel.title4")); // NOI18N
		
		javax.swing.GroupLayout coreMemMapPaneLayout = new javax.swing.GroupLayout(
				coreMemMapPane);
		coreMemMapPane.setLayout(coreMemMapPaneLayout);
		coreMemMapPaneLayout.setHorizontalGroup(coreMemMapPaneLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				coreMemMapPaneLayout
						.createSequentialGroup()
						.addContainerGap()
						.addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE,
								1023, Short.MAX_VALUE).addContainerGap()));
		coreMemMapPaneLayout.setVerticalGroup(coreMemMapPaneLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				coreMemMapPaneLayout
						.createSequentialGroup()
						.addContainerGap()
		...
		coreMainPane.addTab(
				resourceMap.getString("coreMemMapPane.TabConstraints.tabTitle"),
				coreMemMapPane); // NOI18N
		...
		javax.swing.GroupLayout coreSimOptsPaneLayout = new javax.swing.GroupLayout(
				coreSimOptsPane);
		coreSimOptsPane.setLayout(coreSimOptsPaneLayout);
		coreSimOptsPaneLayout
				.setHorizontalGroup(coreSimOptsPaneLayout
		...
		coreSimOptsPaneLayout
				.setVerticalGroup(coreSimOptsPaneLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								coreSimOptsPaneLayout
										.createSequentialGroup()
		...
		coreMainPane.addTab(
				resourceMap.getString("coreSimOptsPane.TabConstraints.tabTitle"),
				coreSimOptsPane); // NOI18N
		...
		javax.swing.GroupLayout coreConsolePaneLayout = new javax.swing.GroupLayout(
				coreConsolePane);
		coreConsolePane.setLayout(coreConsolePaneLayout);
		coreConsolePaneLayout
				.setHorizontalGroup(coreConsolePaneLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								coreConsolePaneLayout
										.createSequentialGroup()
										...
										.addContainerGap()));
		coreConsolePaneLayout
				.setVerticalGroup(coreConsolePaneLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								coreConsolePaneLayout
		...
		coreMainPane.addTab(
				resourceMap.getString("coreConsolePane.TabConstraints.tabTitle"),
				coreConsolePane); // NOI18N
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup()
						...
						.addPreferredGap(
								javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(coreMainPane, javax.swing.GroupLayout.DEFAULT_SIZE,
								485, Short.MAX_VALUE).addGap(12, 12, 12)));
		
		pack();
	}// </editor-fold>//GEN-END:initComponents
	
	private void simCLClearActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_simCLClearActionPerformed
		// TODO add your handling code here:
		simCLOutput.setText("");
	}// GEN-LAST:event_simCLClearActionPerformed
	
	private void simCLExecActionPerformed(java.awt.event.ActionEvent evt)
	{// GEN-FIRST:event_simCLExecActionPerformed
	...
	private void simCLConsoleKeyPressed(java.awt.event.KeyEvent evt)
	{// GEN-FIRST:event_simCLConsoleKeyPressed
		if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER)
			simCLExecActionPerformed(null);
		else if (simCLConsole.getText().equals("")
	...
	{// GEN-FIRST:event_formInternalFrameActivated
	}// GEN-LAST:event_formInternalFrameActivated
	
	private void tblRegFileKeyPressed(java.awt.event.KeyEvent evt)
	{// GEN-FIRST:event_tblRegFileKeyPressed
	
	}// GEN-LAST:event_tblRegFileKeyPressed
	
	private void tblMemMapMousePressed(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_tblMemMapMousePressed
	
	}// GEN-LAST:event_tblMemMapMousePressed
	
	private void tblMemMapMouseClicked(java.awt.event.MouseEvent evt)
	{// GEN-FIRST:event_tblMemMapMouseClicked
	...
	private void chkEXEXFwdRStateChanged(javax.swing.event.ChangeEvent evt)
	{// GEN-FIRST:event_chkEXEXFwdRStateChanged
	...
	private void chkMEMEXFwdRStateChanged(javax.swing.event.ChangeEvent evt)
	{// GEN-FIRST:event_chkMEMEXFwdRStateChanged
	...
	private void chkMEMEXFwdLWStateChanged(javax.swing.event.ChangeEvent evt)
	{// GEN-FIRST:event_chkMEMEXFwdLWStateChanged
	...
	public final void updateFontSize()
	{
		...
		tblRegFile.setRowHeight(tblRegFile.getFontMetrics(tblRegFile.getFont())
				.getHeight() + 5);
		tblProgram.setFont(tblProgram.getFont().deriveFont(Config.devFontSize + 0.0f));
		tblProgram.setRowHeight(tblProgram.getFontMetrics(tblProgram.getFont())
				.getHeight() + 5);
		tblMemMap.setFont(tblMemMap.getFont().deriveFont(Config.devFontSize + 0.0f));
		tblMemMap
				.setRowHeight(tblMemMap.getFontMetrics(tblMemMap.getFont()).getHeight() + 5);
	}
	...
	{
		javax.swing.table.DefaultTableModel memMap = (javax.swing.table.DefaultTableModel) tblMemMap
				.getModel();
	...
	public final void updateComponents()
	{
		...
		for (int i = 0; i < 32; i++)
		{
			...
			tblRegFile.setValueAt(String.format("0x%08x",
					((SimCore) sim).regfile.read(i) & 0xffffffffL), i, 1);
		}
	 ...
	 *
	 * @param memVis
	 *            Reference to the memory visualizer
	 */
	...
	public void updateAttributeForMemoryVisualizers()
	{
		...
		for (int i = 0; i < memoryVisualizers.size(); i++)
		{
			...
			plptool.Msg.D(
					"adding attribute "
							+ String.format("(%08x-%08x)", attrSet[i][0], attrSet[i][1]),
					3, this);
		}
	...
	{
		javax.swing.table.DefaultTableModel program = (javax.swing.table.DefaultTableModel) tblProgram
				.getModel();
	...
	public final void fillProgramMemoryTable()
	{
		...
		Object[][] objCode = ((plptool.mods.MemModule) plp.ioreg.getModule(mainMemIndex))
				.getValueSet();
		Object row[];
		for (int i = 0; i < objCode.length; i++)
		{
			...
			{
				row = new Object[] { "", false, String.format("0x%08x", objCode[i][0]),
	...
	public final void updateProgramMemoryTablePC()
	{
		if (((SimCore) sim).pc.eval() != old_pc)
		{
			...
			{
				if (((SimCore) sim).id_stage.instrAddr == Long.parseLong(
						((String) program.getValueAt(i, 2)).substring(2), 16)
						&& ((SimCore) sim).ex_stage.hot)
					program.setValueAt("ID>", i, 0);
				else if (((SimCore) sim).ex_stage.instrAddr == Long.parseLong(
						((String) program.getValueAt(i, 2)).substring(2), 16)
						&& ((SimCore) sim).mem_stage.hot)
					program.setValueAt("EX>", i, 0);
				else if (((SimCore) sim).mem_stage.instrAddr == Long.parseLong(
						((String) program.getValueAt(i, 2)).substring(2), 16)
						&& ((SimCore) sim).wb_stage.hot)
					program.setValueAt("MEM>", i, 0);
				else if (((SimCore) sim).wb_stage.instrAddr == Long.parseLong(
						((String) program.getValueAt(i, 2)).substring(2), 16)
	...
	class CustomCellTextField extends JTextField
	{
		...
		public CustomCellTextField(SimCoreGUI g_sim)
		{
			...
			addFocusListener(new CellFocusListener(g_sim));
		}
	}

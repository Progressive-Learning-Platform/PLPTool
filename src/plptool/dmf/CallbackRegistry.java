...
/**
 * This class handles callback registration in PLPTool. Callbacks are registered by
 * passing an implementation of the Callback interface to the register method along with
 * the callback number.
 *
 * @author Wira
 */
public class CallbackRegistry
{
	...
	/**
	 * Perform callback. Should be triggered by PLPTool ONLY. Do NOT call this method from
	 * a module.
	 *
	 * @param callbackNum
	 *            Callback number to perform
	 * @param param
	 *            Parameter to the callback implementation
	 * @return True if one of the methods registered to this callback return true, false
	 *         otherwise
	 */
	public static boolean callback(int callbackNum, Object param)
	{
		...
		for (int i = 0; i < callbacks[callbackNum].size(); i++)
		{
			...
			Msg.D("callback[" + callbackNum + "]: " + c.getClass().getCanonicalName(), 4,
					null);
	...
	/**
	 * Register a callback interface implementation to the specified callback number.
	 *
	 * @param callbackNum
	 *            Callback number to register for
	 * @param callback
	 *            Reference to an instance of the callback interface implementation
	 ...
	 *
	 * @param callbackNumbers
	 *            Callback numbers to register for
	 * @param callback
	 *            Reference to an instance of the callback interface implementation

...
public class GUITester implements Tester
{
	...
	public void run(ProjectDriver plp)
	{
		...
		if (f.exists())
		{
			...
			{
				AutoTest.p(f.getAbsolutePath()
						+ " exists. Delete this file first before running GUI autotest.");
				System.exit(-1);
			}
			else
				f.delete();
	...
	static class Text
	{
		public final static String file1 = "#PLPTool autotest\n" + "#\n"
				+ ".org 0x10000000\n\n" + "loop:\n" + "\tj loop\n" + "\tnop\n";
		
		public final static String file2 = "#PLPTool autotest 2\n" + "#\n"
				+ ".org 0x10000000\n\n" + "\tli $a0, string\n\n" + "loop:\n"

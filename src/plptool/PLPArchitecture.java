...
/**
 * This abstract class serves as a skeleton for the ISA's metaclass. The ProjectDriver
 * class depends on the extension of this class to perform ISA specific actions such as
 * creating an assembler, simulation routines, etc. See plptool.mips.Architecture for an
 * example implementation. This class has access to the currently active ProjectDriver
 * instance 'plp'
 *
 * @author wira
 */
public abstract class PLPArchitecture
{
	 ...
	 *
	 * @param plp
	 *            New ProjectDriver instance to use
	 */
	 ...
	 *
	 * @return boolean specifying whether the ISA implements the simulation core GUI frame
	 */
	 ...
	 *
	 * @return boolean specifying whether the ISA implements the board programmer class
	 */
	...
	/**
	 * Additional simulation initialization code. Called by the ProjectDriver AFTER the
	 * I/O registry has been initialized but before I/O module presets are loaded to the
	 * simulation
	 *
	 */
	...
	/**
	 * Additional simulation initialization code called after all simulation elements are
	 * initialized
	 */
	...
	/**
	 * Set architecture-specific simulation configuration to the current open project
	 * driver. ProjectDriver.open() will pass an array of String tokens split with the
	 * string "::" as the delimiter. For example, the line in config file "foo::bar" will
	 * be passed on to this function as {"foo", "bar"} in configStr
	 *
	 * @param configStr
	 *            Configuration string saved in plp.simconfig
	 */
	...
	/**
	 * Called when a new project with the specified ISA has been called. This function is
	 * NOT called if the user provides a source file to import while creating a new
	 * project, e.g. if the user uses the '-c' command line from the terminal
	 */
	...
	/**
	 * Cleanup the mess the project might have done. This is called when the user changes
	 * the ISA for the project, or the project is closed
	 */
	public void cleanup()
	{
	}
	...
	/**
	 * CLI Simulation command, called when PLPTool is being run in scripted simulation
	 * mode from command line. This function interprets a simulation script line.
	 * 
	 * @param cmd
	 */
